...
Check the README.txt file (present in the dataset) for further details about this dataset.
...
The data should be downloaded and decompressed in the working directory.
